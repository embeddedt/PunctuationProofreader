...
export function startCheck() {
    ...
    if(process.env.NODE_ENV == 'production') {
        ...
        inter = setInterval(function() {
            var minimalUserResponseInMiliseconds = 10000;
